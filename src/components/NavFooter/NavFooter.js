...
export default function NavFooter(){
    return (
        <div className={styles.NavFooter}>
            ...
            <a href='https://jmp.sh/0Ftmc9xR' className={styles.footerLink} target="_blank"><img src='https://i.imgur.com/5j7wzpH.png' title='Resume' className={styles.footerIcon}></img></a>
